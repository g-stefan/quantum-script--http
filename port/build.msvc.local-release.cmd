...
echo -^> local-release quantum-script-extension-http
...
call :cmdX xyo-cc quantum-script-extension-http --archive-release-sha512 --version-file=source/quantum-script-extension-http.version.ini
