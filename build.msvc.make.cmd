...
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-http.static.compile.info
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-http.dynamic.compile.info
